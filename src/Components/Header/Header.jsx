 ...
 const toggleCloser = () => {
  ...
  return (
    <>
      <header className="flex shadow-md py-4 px-4 sm:px-10 bg-white font-[sans-serif] min-h-[70px] tracking-wide relative z-50">
        <div className="flex flex-wrap items-center justify-between gap-5 w-full">
          ...
          >
            <button
              id="toggleClose" onClick={toggleCloser}
            ...
            <ul onClick={toggleCloser} className="lg:flex gap-x-5 max-lg:space-y-3 max-lg:fixed max-lg:bg-white max-lg:w-1/2 max-lg:min-w-[300px] max-lg:top-0 max-lg:left-0 max-lg:p-6 max-lg:h-full max-lg:shadow-md max-lg:overflow-auto z-50">
    ...
    hover:text-[#007bff]`
          ...
          <div className='flex ml-auto space-x-6 items-center justify-center'>
       ...
       <svg xmlns="http://www.w3.org/2000/svg" width="20px" className="cursor-pointer" viewBox="0 0 512 512">
        ...
        <button onClick={toggleHandler} id="toggleOpen" className='lg:hidden'>
